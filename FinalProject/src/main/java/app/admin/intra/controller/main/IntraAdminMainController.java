package app.admin.intra.controller.main;
...
@Controller
@RequestMapping("/admin/intra")
public class IntraAdminMainController {
	@Autowired
	...
	@RequestMapping("/")
	public String home() {
		return "thymeleaf/admin/intra/index";
	}
	...
	public String loginGet(
		...
		loginPrevUrl.execute(request, model, "/admin/intra/");
